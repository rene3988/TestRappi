...
import com.renecabanas.testrappi.themoviedb.base.BaseLifecycleActivity
import com.renecabanas.testrappi.themoviedb.data.movie.Movie
import com.renecabanas.testrappi.themoviedb.data.movie.MovieLocalDS
        ...
        viewModel.detailRepoLD.observe(this, Observer<List<Movie>> {
            it?.let {
                it[0].let {
                    ...
                    detailParalax.setImageURI("${ReneConfig.IMG_BASE_URL}${it.posterPath}")
                }
                movie = it[0]
